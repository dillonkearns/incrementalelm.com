...
all =
    [ { title = "Elm GraphQL Seminar"
      , url = "elm-graphql-seminar"
      , body = """| Subheader
    The Elm GraphQL Seminar

Would you like to leverage elm-graphql best practices to make your codebase more robust? Mastering some core skills and patterns will make writing and maintaining {Code|elm-graphql} code a lot easier. The seminar format allows you to learn from other elm-graphql users' questions and experiences. Plus you'll get help with your specific questions to help you apply elm-graphql best practices where you need them most.

| List
    - How do you grow your elm-graphql code without creating lots of duplication?
    - How do you use expressive elm types to help you avoid bugs and make code easier to read when you use {Code|elm-graphql}?
    - How do split out and organize your {Code|elm-graphql} queries?
