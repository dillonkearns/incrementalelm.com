...
body dimensions =
    ...
    , resourcesView dimensions gettingStartedResources
    ]
                ...
                |> List.map
                    (\resource ->
                        Element.column
                            ...
                            , Element.paragraph [ Style.fontSize.small, Element.Font.center ] [ Element.text (resource.description |> Maybe.withDefault "") ]
                            ]
                    )
            )
        ]
...
gettingStartedResources : List Resource
